      ...
      <div class="z-51 h-full w-full flex items-center justify-center">
        <Transition name="dialog">
          <div
            v-show="isVisible"
            ref="contentRef"
            class="dialog-content bg-popover ring-secondary/10 relative w-full cursor-default rounded-lg p-6 shadow-2xl ring-1 dark:bg-gray-800 dark:ring-gray-700/50"
