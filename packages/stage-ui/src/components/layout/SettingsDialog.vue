  ...
  <Dialog v-model="showDialog">
    <div class="mb-6 flex items-center justify-between">
      <div class="flex items-center gap-2">
        ...
        <span class="text-lg text-primary-900 dark:text-gray-100 font-medium">设置</span>
      </div>
      <button class="rounded-md p-1 text-primary-900 dark:text-gray-100 transition-colors hover:bg-neutral-100/50 dark:hover:bg-gray-700/50" @click="showDialog = false">
        <div class="i-lucide-x h-5 w-5" />
      </button>
    </div>
    <div class="space-y-4">
      <template v-if="!isLoggedIn">
        <div class="flex items-center justify-between rounded-lg p-3 text-primary-900 dark:text-gray-100 transition-colors hover:bg-neutral-100/50 dark:hover:bg-gray-700/50">
          <div class="flex items-center gap-2">
