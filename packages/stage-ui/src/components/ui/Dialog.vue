      ...
      <div class="z-51 h-full w-full flex items-center justify-center">
        <Transition name="dialog">
          <div
            v-show="isVisible"
            ref="contentRef"
            class="dialog-content relative w-full cursor-default rounded-lg bg-popover dark:bg-gray-800 p-6 shadow-2xl ring-1 ring-secondary/10 dark:ring-gray-700/50"
