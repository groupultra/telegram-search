...
<template>
  <div class="h-full flex flex-col">
    <header class="flex items-center border-b border-b-neutral-200 dark:border-b-gray-700 p-4 px-4">
      <div class="flex items-center gap-2">
        <span class="text-lg font-medium text-primary-900 dark:text-gray-100">Search</span>
      </div>
    </header>
    ...
    <div class="flex flex-col px-8 pt-8">
      <div class="w-full flex items-center gap-2">
        <input
          v-model="keyword"
          class="flex-1 border border-neutral-200 dark:border-gray-600 rounded-md px-4 py-2 text-primary-900 dark:text-gray-100 bg-white dark:bg-gray-800 outline-none focus:ring-2 focus:ring-primary dark:focus:ring-offset-gray-800"
    ...
    >
      ...
      <template v-else-if="isLoading">
        <div class="flex flex-col items-center justify-center py-12 text-complementary-500 dark:text-gray-400 opacity-70">
