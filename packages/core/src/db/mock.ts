...
// https://github.com/drizzle-team/drizzle-orm/issues/4205#issuecomment-2747745901
export async function mockDB(schema: Record<string, any>): Promise<CoreDB> {
  ...
  const db = drizzle(client, { schema }) as unknown as CoreDB
